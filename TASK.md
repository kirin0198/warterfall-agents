...
- [ ] TASK-003: Commit 1 (§②) + push | git

### Phase 2 — Commit 2 (§①)
- [ ] TASK-004: Add `## Field Reference` section to `src/.claude/rules/agent-communication-protocol.md` before `## STATUS Definitions` | Target file: src/.claude/rules/agent-communication-protocol.md
- [ ] TASK-005: Replace "Output on Completion" templates in 37 agent files with 5-line short form | Target files: .claude/agents/*.md (37 files, excl. discovery/delivery/operations-flow)
