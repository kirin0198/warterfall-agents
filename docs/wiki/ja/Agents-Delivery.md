...
このページはもとの Agents-Reference.md を5ページに分割したもの（#42）です。Deliveryドメインエージェントを扱います。他のドメインは兄弟ページを参照してください: [オーケストレーター・横断系](./Agents-Orchestrators.md)、[Discovery](./Agents-Discovery.md)、[Operations](./Agents-Operations.md)、[Maintenance](./Agents-Maintenance.md)。
