...
3. `docs/wiki/*/Platform-Guide.md` 「Sandbox & Permission Modes」節
...
**"Sandbox & Permission Modes"**（`docs/wiki/en/Platform-Guide.md` と `docs/wiki/ja/Platform-Guide.md` の両方に追加）
...
- `docs/wiki/en/Rules-Reference.md` / `docs/wiki/ja/Rules-Reference.md` の末尾にエントリ `sandbox-policy` を追加
...
- **成果物**:
  - `docs/wiki/en/Platform-Guide.md` / `docs/wiki/ja/Platform-Guide.md`（§3 の新節追加）
  - `docs/wiki/en/Agents-Reference.md` / `docs/wiki/ja/Agents-Reference.md`（§4.3 の Safety Agents 節追加、26→27 更新）
  - `docs/wiki/en/Rules-Reference.md` / `docs/wiki/ja/Rules-Reference.md`（§4.4 の sandbox-policy 節追加）
...
- **成果物**:
  - `docs/wiki/en/Platform-Guide.md` / `docs/wiki/ja/Platform-Guide.md`: "Sandbox & Permission Modes" 節に container モード記述を追加、比較表に `container via devcontainer` 行を追加
  - `docs/wiki/en/Agents-Reference.md` / `docs/wiki/ja/Agents-Reference.md`: infra-builder 節に sandbox infra 生成責務を追記、sandbox-runner 節に container mode / fallback を追記
  - `docs/wiki/en/Rules-Reference.md` / `docs/wiki/ja/Rules-Reference.md`: sandbox-policy の Sandbox Modes に `container` 記述を追加
